<template>
  <div id="main">
    <div class="header">
      <div class="logo">
        <a href="https://www.bigscity.com/" target="_blank">
          <img src="static/images/bigscitylogo.png" alt="BIGSCITYLOGO">
        </a>
      </div>
      <div class="left">
        <div class="menu">
...
export default {
  ...
        const li = $(this), width = li.width();
        const items = li.children('ul');
        if (items.length) items.width(width);
      })
    }
}
</script>
